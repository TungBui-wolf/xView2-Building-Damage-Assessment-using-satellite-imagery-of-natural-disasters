...
def main_loc():
    ...
    snapshot_name = '_resnet50_unet_loc'

    log_dir = 'logs/resnet50_unet/'
    ...
    model = ResNet50_Unet_Loc(pretrained=True, bilinear=False).cuda()
...
def main_cls():
    ...
    weight_dir = 'weights'
    makedirs(weight_dir, exist_ok=True)
    snapshot_name = '_resnet50_unet_cls'
    ...
    model = ResNet50_Unet_Double(pretrained=True, bilinear=False).cuda()
